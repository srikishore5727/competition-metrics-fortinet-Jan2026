import { Lightbulb, Zap, Search, Target } from 'lucide-react';
import { SlideContainer } from './design-system';

interface SlideIntelDividerProps {
  onNavigateHome?: () => void;
}
  ...
  return (
    <SlideContainer slideNumber={20} onNavigateHome={onNavigateHome}>
      <div className="flex-1 flex flex-col justify-center items-center px-12">
        ...
        {/* Icon Badge */}
        <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center shadow-xl mb-8">
        ...
        <p className="text-xl text-gray-600 mb-14 text-center max-w-3xl">
          Strategic recommendations and competitive gap analysis for market leadership
        </p>
