...
export function SlideLLMDivider({ onNavigateHome }: SlideLLMDividerProps) {
  const sections = [
    ...
    { 
      name: 'Category LLM Performance', 
      color: '#FFB14A', 
      icon: BarChart4,
      description: 'Segment-wise AI analysis'
    },
    { 
      name: 'AI Overview Presence', 
      color: '#7ED957', 
      icon: Eye,
      description: 'Google AI snapshot metrics'
    },
  ];

  return (
    <SlideContainer slideNumber={14} onNavigateHome={onNavigateHome}>
